...
public class Saga {
    ...
    public void setParte(int parte) { this.parte = parte; }
    ...
    public List<Personaxe> getPersonaxes() { return personaxes; }
    public void setPersonaxes(List<Personaxe> personaxes) { this.personaxes = personaxes; }
}